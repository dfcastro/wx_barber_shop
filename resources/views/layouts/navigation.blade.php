                        ...
                        @if (Auth::user()->is_admin)
                            ...
                            <div class="hidden sm:flex sm:items-center sm:ms-6">
                                <x-dropdown align="left" width="48">
                                    ...
                                    <x-slot name="content">
                                        <x-dropdown-link :href="route('admin.financials.index')">
                                            {{ __('Relatório de Faturamento') }}
                                        </x-dropdown-link>
                                        <x-dropdown-link :href="route('admin.expense-categories.index')">
                                            {{ __('Categorias de Despesas') }}
                                        </x-dropdown-link>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="ms-4 text-sm text-gray-700 dark:text-gray-300 underline">Register</a>
                    @endif
                @endauth
            </div>
        ...
        <div class="pt-2 pb-3 space-y-1">
            @auth
                @if (Auth::user()->is_admin)
                    ...
                    {{-- SEÇÃO FINANCEIRA RESPONSIVA --}}
                    <div class="pt-2 pb-1 border-t border-gray-200 dark:border-gray-600">
                        <div class="px-4">
                            <div class="font-medium text-base text-gray-800 dark:text-gray-200">Financeiro</div>
                        </div>
                        <x-responsive-nav-link :href="route('admin.financials.index')" :active="request()->routeIs('admin.financials.*')">
                            {{ __('Relatório de Faturamento') }}
                        </x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('admin.expense-categories.index')" :active="request()->routeIs('admin.expense-categories.*')">
                            {{ __('Categorias de Despesas') }}
                        </x-responsive-nav-link>
                ...
                @else
                    {{-- LINKS RESPONSIVOS PARA CLIENTES --}}
