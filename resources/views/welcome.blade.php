...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-900 bg-cover bg-center selection:bg-brand-gold selection:text-white" style="background-image: url('{{ asset('images/barber-bg.jpg') }}')">
            {{-- Overlay escuro para legibilidade --}}
            <div class="absolute inset-0 bg-black opacity-60"></div>

            <div class="relative max-w-7xl mx-auto p-6 lg:p-8 text-center">
                <div class="flex justify-center">
                   <img src="{{ asset('images/logo-barbearia.png') }}" alt="Logo Barbearia" class="w-48 h-auto">
                </div>
